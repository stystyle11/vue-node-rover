<template>
    <div >
        <svg :fill="fill" :height="heightPx" :width="widthPx" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<script setup>
const props = defineProps({fill:{type:String,required:true,default:'#ccc'},
heightPx:{type:String,required:true,default:'#100px'},
widthPx:{type:String,required:true,default:'#100px'}})
</script>
